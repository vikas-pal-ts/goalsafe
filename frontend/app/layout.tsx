          ...
          <main className="flex-1 min-w-0 relative overflow-hidden">
            ...
            <header className="h-[72px] bg-white border-b border-line flex items-center justify-between px-7 relative z-10">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-[12px] font-medium text-body">Vikas Pal</span>
                <button className="w-8 h-8 rounded-full bg-[#F6F8F9] border border-[#EEF1F2] text-muted flex items-center justify-center" aria-label="Open account menu">
